...
class Modal {
    ...
    handleTransitionEnd(e) {
        ...
        if (this.isClosing && !this.modalContent.classList.contains('active')) {
            ...
            if(this.id === 'callback-modal') {
                const formName = this.modalContent.querySelector('[name="form_name"]');

                this.modalContent.removeAttribute('data-check-switch');
                formName.value = formName.dataset.valueDefault;
            }
        }
    }
}
